                      ...
                      <ul className="space-y-3 text-sm" aria-labelledby="dropdownDefault">
                        <li className="flex items-center">
                          <input
                            ...
                            className="w-5 h-4 bg-gray-100 border-gray-300 rounded text-[#f3c41a] focus:ring-[#f3c41a] dark:focus:ring-[#f3c41a] dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                          />
